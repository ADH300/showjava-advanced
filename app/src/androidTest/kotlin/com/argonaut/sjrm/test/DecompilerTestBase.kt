...
package com.argonaut.sjrm.test
...
abstract class DecompilerTestBase {
    ...
    private val testAssets: File
        get() = File(Environment.getExternalStorageDirectory(), "sjadvanced")
            .resolve("test-assets")
    ...
    fun testDecompiler() {
        ...
        val outputDirectory = File(
            Environment.getExternalStorageDirectory(), "sjadvanced/sources/${data.getString("name")}"
        )
