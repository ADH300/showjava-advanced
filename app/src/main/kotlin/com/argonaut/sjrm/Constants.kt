...
object Constants {
    ...
    interface WORKER {
        ...
        companion object {
            const val STATUS_TYPE = "com.argonaut.sjrm.worker.STATUS_TYPE"
            const val STATUS_TITLE = "com.argonaut.sjrm.worker.STATUS_TITLE"
            const val STATUS_MESSAGE = "com.argonaut.sjrm.worker.STATUS_MESSAGE"

            const val PROGRESS_NOTIFICATION_CHANNEL = "com.argonaut.sjrm.worker.notification.progress"
            const val COMPLETION_NOTIFICATION_CHANNEL = "com.argonaut.sjrm.worker.notification.completion"
        ...
        interface ACTION {
            companion object {
                ...
                const val BROADCAST = "com.argonaut.sjrm.worker.action.BROADCAST"

                // Action to instruct the receiver to stop the worker
                const val STOP = "com.argonaut.sjrm.worker.action.STOP"
            }
        }
    }
}